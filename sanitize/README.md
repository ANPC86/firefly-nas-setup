...
```bash
python sanitize/sanitize_pdf.py statements/ --recursive --skip-existing --names .local/pii-names.txt --strict
python sanitize/sanitize_pdf.py statements/ --recursive --newer-than 2026-09-15T12:40 --names .local/pii-names.txt --strict
```
